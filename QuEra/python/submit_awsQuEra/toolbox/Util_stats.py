...
#...!...!....................
def do_yield_stats(dataY,verb=1): # vectorized version
    '''
...
note: var_nj fixed 2023-05
    ...
    if verb>0: print('Steve: nBelow0=%d nAbove1=%d'%(nBelow0,nAbove1))
    ...
    if verb>0: print('Steve:err no zeros:',np.all(probErr))  # never can be false
