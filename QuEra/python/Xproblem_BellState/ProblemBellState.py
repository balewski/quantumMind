...
class ProblemBellState():  #  
    def __init__(self, args, jobMD=None, expD=None):
        ...
        if jobMD==None:
            ...
            self.meta=jobMD
            self.meta['analyzis']['read_err_eps']=args.readErrEps
...
#...!...!..................
    def analyzeExperiment(self):
        ...
        if amd['read_err_eps']!=None:
            eps=amd['read_err_eps']
            #print('\nsum Probs before   eps=%.2f\n'%eps,dataPS)
            dataPSM=mitigate_probs_readErr_QuEra_2bits(dataPS,eps)
            #print('\nafter  \n',dataPSM)
            self.expD['prob_sum_mit']=dataPSM
