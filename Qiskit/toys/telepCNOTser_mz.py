#!/usr/bin/env python3
# serial  circuit for CNOT teleportation, based on
# https://arxiv.org/pdf/1902.02891
...
def create_cnot_teleport_symetric(inpCT):
    """
    Create a circuit for CNOT gate teleportation.
    Symmetric version
...
qc = create_cnot_teleport_symetric(inpCT)
