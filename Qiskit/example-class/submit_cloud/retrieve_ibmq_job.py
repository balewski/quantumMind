...
if __name__ == "__main__":
    ...
    if 'TaskMidCircMeas'==jobMD['payload']['class_name']:
        from TaskMidCircMeas import TaskMidCircMeas
        task=TaskMidCircMeas(args,jobMD,expD)        
    if 'TaskTomoTeleport'==jobMD['payload']['class_name']:
        from TaskTomoTeleport import TaskTomoTeleport
        task=TaskTomoTeleport(args,jobMD,expD)
