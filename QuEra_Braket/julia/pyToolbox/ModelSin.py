...
def sin_f(x,A,F,P,C): # constant bias
    return   C + A*np.sin(2*np.pi*F*x+P)


###########################################################
# The standard practice of defining an ``lmfit`` model

class ModelSin(lmfit.model.Model):
...
#...!...!..................        
    def guess(self, data, x=None, **kwargs):
        ...
        params = self.make_params(A=ampl0, F=freq0, P=phase0, C=offset0)
